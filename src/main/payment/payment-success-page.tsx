...
import { CheckCircleOutlined, HomeOutlined, PrinterOutlined, DownloadOutlined } from "@ant-design/icons"
import { Button, Card, Col, Row, Space, Typography, Divider, Tag } from "antd"
...
const PaymentSuccessPage = ({ transactionInfo }: PaymentSuccessPageProps) => {
  ...
  const transaction = transactionInfo || defaultTransactionInfo
      ...
      <div style={{ maxWidth: "800px", margin: "0 auto" }}>
        ...
        <Card style={{ marginBottom: "24px", textAlign: "center" }}>
          <Space direction="vertical" size="large">
            ...
            <div>
              ...
              <Text style={{ fontSize: "16px", color: "#666" }}>Giao dịch của bạn đã được xử lý thành công</Text>
            </div>
          ...
          <Row gutter={[24, 16]}>
            <Col xs={24} sm={12}>
              <div style={{ marginBottom: "16px" }}>
                ...
                <br />
                <Text style={{ fontSize: "16px", fontWeight: "500" }}>{transaction.orderId}</Text>
              </div>
            </Col>
            <Col xs={24} sm={12}>
              <div style={{ marginBottom: "16px" }}>
                ...
                <br />
                <Text style={{ fontSize: "16px", fontWeight: "500" }}>{transaction.transactionId}</Text>
              </div>
            </Col>
            <Col xs={24} sm={12}>
              <div style={{ marginBottom: "16px" }}>
            ...
            <Col xs={24} sm={12}>
              <div style={{ marginBottom: "16px" }}>
                ...
                <br />
                <Text style={{ fontSize: "16px", fontWeight: "500" }}>{transaction.paymentTime}</Text>
              </div>
            </Col>
            <Col xs={24} sm={12}>
              <div style={{ marginBottom: "16px" }}>
                ...
                <br />
                <Text style={{ fontSize: "16px", fontWeight: "500" }}>{transaction.customerName}</Text>
              </div>
            </Col>
            <Col xs={24} sm={12}>
              <div style={{ marginBottom: "16px" }}>
                ...
                <br />
                <Text style={{ fontSize: "16px", fontWeight: "500" }}>{transaction.paymentMethod}</Text>
              </div>
            </Col>
          </Row>
        </Card>
        ...
        <Card>
          ...
          <Space direction="vertical" style={{ width: "100%" }}>
            ...
            <Text>✓ Bạn có thể theo dõi trạng thái đơn hàng trong tài khoản</Text>
          </Space>
